...
use App\Http\Controllers\VisiMisi\VisiMisiController;
...
Route::group(['middleware' => 'auth'], function(){
    ...
    // Route::put('/pengaturan-visimisi-update', [VisiMisiController::class, 'updateAdminVisimisi']);
    // Route::post('/pengaturan-visimisi/update',[VisiMisiController::class, 'updateAdminVisiMisi']);
    Route::put('/pengaturan-visimisi/{id}', [VisiMisiController::class, 'updateVisiMisi']);
    // CK Editor
...
Route::get('/sejarah-singkat',function(){
    return view('profil.sejarah-singkat');
});
