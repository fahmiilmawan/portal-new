...
<body>
  ...
  {{-- <section id="about" class="about" style="background-color: #37517e;height:300px">
    <div class="container" data-aos="fade-up" >


      <div class="row content" style="text-align: justify;">
        <div class="title">
          <h1 style="color: white;margin-top: 50px;">KOMPETENSI KEAHLIAN</h1>
          <br>
          <p style="color: grey">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod expedita deleniti dicta natus debitis eveniet perferendis recusandae earum? Porro et quae, similique non quod nulla ad rerum quibusdam accusamus illo.
          </p>
        </div>
      </div>
