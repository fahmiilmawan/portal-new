      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <br>
            <input type="file" name="thumbnail" id="" value="{{old('thumbnail')}}" required>
          </div>
          <div class="form-group">
            <label>Deskripsi</label>
            <input type="text" name="deskripsi" id="" class="form-control" value="{{old('deskripsi')}}" required>
            <small class="form-text text-muted">
              Maksimal deskripsi 140 karakter
            </small>
          ...
          <div class="form-group">
            ...
            <select id="inputState" class="form-control" name="category" style="width: 55rem" required> 
          ...
          <div class="form-group">
            <textarea name="konten" id="content" required>{{old('konten')}}</textarea>
          </div>
          <div class="form-group">
