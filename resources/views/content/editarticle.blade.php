...
<form action="/artikel/{{ $artikel->id }}" method="post" style="" enctype="multipart/form-data">
    @csrf
    @method('PUT')
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="deskripsi" id="" class="form-control" value="{{ $artikel->deskripsi }}" required>
