...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/lppm_ri.png" rel="icon">
...
<body>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="/pembelajaran">Pembelajaran</a>
            <ul>
              <li><a href="http://elearning.smklppmribdg.sch.id/" target="_blank">E-Learning</a></li>
              <li><a href="https://mail.smklppmribdg.sch.id/" target="_blank">Mailt</a></li>
            </ul>
          </li>
  ...
  background-image:url('assets/img/foto3.jpg');background-size:cover;background-repeat:no-repeat;">
    ...
    <div class="foto" style="text-align: center">
        <img src="assets/img/lppm_ri.png" alt="" class="img-fluid" width="150px"height="50px" style="padding-top:50px;padding-bottom:20px;">
        <h1 >HUBUNGI KAMI</h1>
        </div>
    ...
    <div class="container" >
      <div class="row">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
          ...
          <img src="assets/img/lppm_ri.png" class="" alt="" style="width:250px;margin-left: 100px;margin-bottom: 50px;">
