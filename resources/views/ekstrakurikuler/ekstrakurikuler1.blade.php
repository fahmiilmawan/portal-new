...
<div class="container1" data-aos="fade-up" style="padding:50px;background-color:white;">
    ...
    <div class="foto" style="text-align:center;">
        <img src="assets/img/lppm_ri.png" alt="" class="img-fluid" width="200px"height="50px">
        <h2 >PASKIBRA</h2>
...
<div class="section-title" style="margin-top: 50px;padding-top:80px;">
  <h2>KETUA <br>EKSTRAKURIKULER PASKIBRA </h2>
    ...
    <div class="row g-0">
      ...
      <div class="col-sm-12 col-md-8">
        <div class="card-body" style="text-align:justify;">
          <h5 class="card-title" style="text-align:center;">SAMBUTAN KETUA<br> EKSTRAKURIKULER PASKIBRA</h5>
